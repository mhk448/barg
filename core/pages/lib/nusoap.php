...
class nusoap_base {
    ...
    * @access	public
	*/
	function serialize_val($val,$name=false,$type=false,$name_ns='http://tejarat/paymentGateway/definitions',$type_ns=false,$attributes=false,$use='encoded',$soapval=false) {
		$name_ns='http://tejarat/paymentGateway/definitions';
