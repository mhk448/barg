    ...
    <div id="content">
        ...
        <div style="width: 100%;float: left;text-align:justify">
            <div style="width: 48%;float: right">
                ...
                <p style="font-size:12pt;line-height: 2;">شما می توانید پروژه ی ترجمه خود را به سادگی در سایت ثبت کنید، برای اینکار کافیست بر روی لینک زیر کلیک نمایید و سفارش خود را ثبت کنید. همچنین در سیستم جدید و برای اولین بار در کشور سیستم ترجمه آنلاین راه اندازی شده که شما می توانید پروژه ی خود را به صورت آنلاین ثبت، و به مجری آن واگذار و ترجمه را به صورت زنده مشاهده نمایید و در نهایت فایل را تحویل بگیرید. جهت راهنمایی چگونگی ثبت پروژه 
